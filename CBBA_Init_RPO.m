...
function CBBA_Params = CBBA_Init_RPO(N,M)
...
% List agent types 
CBBA_Params.AGENT_TYPES.SERVICER   = 1;
%CBBA_Params.AGENT_TYPES.CAR    = 2;

% List task types
CBBA_Params.TASK_TYPES.VISIT   = 1;
...
CBBA_Params.CM(CBBA_Params.AGENT_TYPES.SERVICER, CBBA_Params.TASK_TYPES.VISIT)  = 1;
