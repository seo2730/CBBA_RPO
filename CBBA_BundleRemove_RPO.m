...
function CBBA_Data = CBBA_BundleRemove_RPO(CBBA_Params, CBBA_Data)
...
for j=1:CBBA_Params.MAX_DEPTH
    ...
    if( CBBA_Data.bundle(j) < 0 )
        ...
        if( outbidForTask )
            ...
            %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
            % Update scoring/cost functions based on result
%             error('Update task scores based on removal from bundle');
%             tasks = 1;
