...
function [score, minStartTime, maxStartTime] = Scoring_CalcScore_RPO_best_global(CBBA_Params,agent,rsoCurr,rsoPrev,timePrev,taskNext,timeNext, CBBA_Data, tasks, newIndex)
