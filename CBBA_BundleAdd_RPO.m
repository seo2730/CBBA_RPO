...
function [CBBA_Data, newBid] = CBBA_BundleAdd_RPO(CBBA_Params, CBBA_Data, agent, tasks)
...
while(bundleFull == 0)
    ...
    [CBBA_Data, bestIdxs, taskTimes, feasibility] = CBBA_ComputeBids_RPO(CBBA_Params, CBBA_Data, agent, tasks, feasibility);
